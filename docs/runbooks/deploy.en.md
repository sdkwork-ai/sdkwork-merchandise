# Runbook — sdkwork-merchandise deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-merchandise-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-merchandise/bundle`, loads the image, starts
