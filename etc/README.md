# sdkwork-merchandise Source Configuration
...
| Item | Value |
| --- | --- |
| `appId` | `sdkwork-merchandise` |
| `runtimeCode` | `merchandise` |
| Config root | `/etc/sdkwork/merchandise/` |
| Runtime TOML | `/etc/sdkwork/merchandise/config.toml` |
| Secrets | `/etc/sdkwork/merchandise/secrets/` |
| Override | `SDKWORK_MERCHANDISE_CONFIG_FILE` |
