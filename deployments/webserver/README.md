...
Module `sdkwork-merchandise` · runtime code `merchandise` · enabled
...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 16 | `merchandise-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 16 | `merchandise-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 16 | `merchandise-staging.sdkwork.com` | 80 |
| demo | `server.demo.toml` | 16 | `merchandise-demo.sdkwork.com` | 80 |
| production | `server.production.toml` | 16 | `merchandise.sdkwork.com` | 443 ssl + 80 |
